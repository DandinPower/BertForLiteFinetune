...
PRETRAIN_DIR = 'data/bert.base.torch/'
NUM_HIDDENS = 768  #small:256 base:768
FFN_NUM_HIDDENS = 3072 #small:512 base:3072
NUM_HEADS = 12 #small:4 base:12
NUM_LAYERS = 12 #small:2 base:12
DROPOUT = 0.1
MAX_LEN = 512
NORM_SHAPE = [768] #small:[256] base:[768]
